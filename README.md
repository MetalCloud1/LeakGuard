...
![Build Status](https://img.shields.io/github/actions/workflow/status/MetalCloud1/Authentication-Service/ci-cd.yaml?branch=dev)](https://github.com/MetalCloud1/Authentication-Service/actions/workflows/ci-cd.yaml)
